...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__styles_main_scss__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_sortablejs__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_qs__ = __webpack_require__(32);
...
if (items) {
  __WEBPACK_IMPORTED_MODULE_1_sortablejs___default.a.create(items, {
...
function destroy(row) {
  ...
  __WEBPACK_IMPORTED_MODULE_2_axios___default.a.post('/admin/delete', __WEBPACK_IMPORTED_MODULE_3_qs___default.a.stringify({
    id: id
  })).then(() => {
    row.remove();
...
function update(row) {
  ...
  let id = row.getAttribute('data-id');
  __WEBPACK_IMPORTED_MODULE_2_axios___default.a.post('/admin/update', __WEBPACK_IMPORTED_MODULE_3_qs___default.a.stringify({
    id: id,
    pattern: pattern,
...
function reweight() {
  ...
  __WEBPACK_IMPORTED_MODULE_2_axios___default.a.post('/admin/weights', __WEBPACK_IMPORTED_MODULE_3_qs___default.a.stringify({
    weights: indexes
...
function runQuery(query) {
  __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('/admin/query', {
    params: {
      q: query
    }
  }).then(res => {
